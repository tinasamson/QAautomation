...
class ProductDetailPage(Utils):
    ...
    def validateProductDetailInfo(self, productName, productPrice):
        ...
        productDetailName = self.driver.find_element(
        ...
        productDetail = self.driver.find_elements(
            By.CSS_SELECTOR, ".product-information p"
        )
        index = 0
    ...
    def validateBrandName(self, brandName):
        brandInfo = self.driver.find_elements(
            By.CSS_SELECTOR, ".product-information p"
        )[-1].text
    ...
    def getProductNamePrice(self):
        ...
        productDetailPrice = self.driver.find_element(
            By.CSS_SELECTOR, ".product-information span span"
        ).text
        return productDetailName, productDetailPrice

    def getCategory(self):
        productDetailCategory = self.driver.find_elements(
            By.CSS_SELECTOR, ".product-information p"
        )[0].text
        return productDetailCategory

    def addMultipleItems(self, quantity):
        productDetailQuantity = self.driver.find_element(
            By.CSS_SELECTOR, ".product-information input#quantity"
        )
