...
customtest(
  'Test case 2: View all products in PLP and verify product information in PDP',
  async ({ page, productPage }) => {
    ...
    await productDetailPage.validateProductDetailInfo(
      productName,
      productPrice,
    );
  },
...
customtest(
  'Test case 4: Filter with brand the product list page',
  async ({ page, productPage }) => {
